...
<div class="col-md-2"></div>
  ...
  <div class="row">
        ...
        <div class="col-md-8 ">
            <h1 id="titles" >
               <b>@yield('container_title')</b>
               
            </h1><br><br>
        </div>
        <div class="col-md-1">
           <a href="homepage" data-toggle="tooltip" data-placement="bottom" title="Close"> <span  id="close"><i class="glyphicon glyphicon-remove-circle"></i></span></a>
        </div>
