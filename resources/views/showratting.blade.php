...
<tbody>
<tr>
<th><strong>Rate My App </strong></th>
</tr>
<?php
if(!empty($result)) {
$i=0;
...
<div class="do" id="tutorial-<?php echo $tutorial["id"]; ?>">
<input type="hidden" readonly name="rating" id="rating"  value="<?php echo $tutorial["rating"]; ?>" />
...
<div><a href="rateit.php">Rate it</div>
</td>
</tr>
<?php		
}
